...
[Synergy](https://symless.com/synergy) Creates the ultimate fat client. The computers in the photo above are two dual-boot Linux/Windows 7/Windows 10 computers. They can be mix and matched in any mode(Linux to Windows, Linux to Linux and Windows to Windows) and still share keyboard, mouse AND CLIPBOARD!  Futhermore if Synergy fails the back-up is a hardware KVM. This is all possible thru the magic of network protocols that even allows memory sharing between two or more computers!
