...
** DONE Check Portal [file://c:/Users/Ray/Desktop/scratch23.org]
...
**** TODO DevOps (Workflow Automation Related), Puppet, Chef (Also Powershell in Separate category below)
     - https://theagileadmin.com/what-is-devops/
     - http://www.geekride.com/hard-link-vs-soft-link/

**** TODO Javascript, JQuery, AngularJS, Mean Stack, Web Development (Related to TSSG Group)
...
**** DONE Website Development (Develop Websites to present Web Skill, Content Writing Ability and make money)
...
* DONE Grocery Shopping and Run Errands					:Car:
   - [X] Coffee 
   - [X] Creamer
